...
const DashBoard = () => {
  ...
  return (
    <main className='mx-auto max-w-7xl md:p-10'>
      <div className='mt-8 flex flex-col items-start justify-between border-b border-gray-200 gap-4 sm:flex-row sm:items-center sm:gap-0'>
            ...
            sortedFiles?.map((file: any) => (
              <li key={file.id} className='cols-span-1 divide-y divide-gray-200 rounded-lg bg-white shadow transition hover:shadow-lg'>
                ...
                <div className="px-6  mt-4 grid grid-cols-3 place-items-center py-2 gap-6 text-xs text-zinc-500">
                  ...
                  size='sm' className='w-full hover:shadow-md' variant='destructive'>
                    {
